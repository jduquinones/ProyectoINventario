...
CREATE TABLE `activos` (
  ...
  KEY `fk_activo_equipos1_idx` (`equipos_id`),
  CONSTRAINT `fk_activo_equipos1` FOREIGN KEY (`equipos_id`) REFERENCES `equipos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2022-04-07  0:56:05
